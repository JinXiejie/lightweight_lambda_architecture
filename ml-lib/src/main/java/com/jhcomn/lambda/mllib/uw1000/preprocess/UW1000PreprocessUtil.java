...
/**
 * UW1000在线平台预处理
 * Created by shimn on 2018/1/10.
 */
public class UW1000PreprocessUtil extends UW1000LocalPreprocessUtil {

    private SparkContext sc = null;
    private FileSystem fs = null;

    public UW1000PreprocessUtil(SparkContext sc, FileSystem fs) {
        this.sc = sc;
        this.fs = fs;
    }
