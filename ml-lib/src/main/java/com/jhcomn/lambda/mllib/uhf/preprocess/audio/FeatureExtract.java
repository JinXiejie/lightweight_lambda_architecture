...
import com.jhcomn.lambda.mllib.uhf.preprocess.feature.Delta;
import com.jhcomn.lambda.mllib.uhf.preprocess.feature.Energy;
import com.jhcomn.lambda.mllib.uhf.preprocess.feature.FeatureVector;
import com.jhcomn.lambda.mllib.uhf.preprocess.feature.MFCC;
...
public class FeatureExtract {
	...
	public void makeMfccFeatureVector() {
		...
		// delta
		if (mfccFeature.length <= 1) {
			delta.setRegressionWindow(1);
			deltaDeltaMfcc = delta.performDelta2D(mfccFeature);
			deltaMfcc = deltaDeltaMfcc;
		}
        else {
