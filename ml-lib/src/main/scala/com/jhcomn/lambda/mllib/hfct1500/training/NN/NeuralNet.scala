package com.jhcomn.lambda.mllib.hfct1500.training.NN
...
/**
  ...
  */
case class NNConfig(
                     @BeanProperty size: Array[Int],
                     @BeanProperty layer: Int,
                     @BeanProperty activation_function: String,
                     @BeanProperty learningRate: Double,
                     @BeanProperty momentum: Double,
                     @BeanProperty scaling_learningRate: Double,
                     @BeanProperty weightPenaltyL2: Double,
                     @BeanProperty nonSparsityPenalty: Double,
                     @BeanProperty sparsityTarget: Double,
                     @BeanProperty inputZeroMaskedFraction: Double,
                     @BeanProperty dropoutFraction: Double,
                     @BeanProperty testing: Double,
                     @BeanProperty output_function: String) extends Serializable
...
class NeuralNet(
                 ...
                 private var initW: Array[BDM[Double]]) extends Serializable  {
