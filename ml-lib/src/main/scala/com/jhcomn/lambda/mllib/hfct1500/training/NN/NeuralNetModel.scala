...
/**
  * NN(neural network)
  */
case class NeuralNetModelWithTags(@BeanProperty val tags: Array[Tag],
                                 @BeanProperty val model: NeuralNetModel) extends Serializable

class NeuralNetModel(
                      @BeanProperty val config: NNConfig,
                      @BeanProperty val weights: Array[BDM[Double]]) extends Serializable{
