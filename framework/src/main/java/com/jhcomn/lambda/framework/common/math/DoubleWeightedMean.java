...
package com.jhcomn.lambda.framework.common.math;
...
public final class DoubleWeightedMean
  ...
  public static void main(String[] args){
      DoubleWeightedMean oj = new DoubleWeightedMean(1, 1, 1);
      oj.increment(2);
      System.out.println("oj result = " + oj.getResult() + "; oj N = " + oj.getN());
  }
}
